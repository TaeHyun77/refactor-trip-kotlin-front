...
const LoginContextProvider = ({ children }) => {
  ...
  const loginSetting = (userData, accessToken) => {
    const { username, role, name, email, gender, age, selfIntro, profileImage } = userData;
    ...
    // 유저 정보 세팅
    const updatedUserInfo = { username, role, name, email, gender, age, selfIntro, profileImage };
